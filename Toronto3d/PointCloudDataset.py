...
class PointCloudDataset(Dataset):
    def __init__(
        ...
        # Shared memory handles and metadata
        ...
        # REMOVED: Pre-sampling loop that filled memory and broke pipe serialization
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        try:
            grid = self._grids[fi]
            # Perform grid queries lazily inside the worker process
